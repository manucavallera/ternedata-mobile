...
const styles = StyleSheet.create({
    ...
    header: { backgroundColor: '#6366f1', paddingTop: 50, paddingBottom: 16, paddingHorizontal: 16 },
    backBtn: { color: '#c7d2fe', fontSize: 14, marginBottom: 4 },
    ...
    toggleCalostrado: { margin: 12, padding: 12, backgroundColor: '#ede9fe', borderRadius: 10, alignItems: 'center' },
    toggleCalostradoText: { color: '#6d28d9', fontWeight: '600', fontSize: 14 },
    btnSubmit: { backgroundColor: '#6366f1', margin: 12, borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 16 },
